...
struct Trivia {
  static let data: [[String: Any]] = [
    ...
    "correctAnswer": "9",
    "choices": "",
    "fact": "11 - 2 = 9 (Abe needs 9 stickers)\n",
    "triviaType": "secondGradeMath",
    "level": "3"],
    ...
    ["question": "Glenn has 6 markers in his\ndesk. He has 1 marker in his\npocket. How many markers\ndoes Glenn have\n____markers\n",
                       ...
                       "triviaType": "secondGradeMath",
                       "level": "2"],
    ["question": "Jake has 16 erasers and\n7 pencils. How many more\nerasers than pencils does\nJake have?\n\n____ more erasers\n",
    "correctAnswer": "9",
    "choices": "",
    "fact": "16 - 7 = 9 more erasers\n",
    "triviaType": "secondGradeMath",
    "level": "2"],
    ["question": "There are 12 toys in a box.\nThen Ellen takes some toys\nout of the box. Now there are\n8 toys in the box. How many\ntoys did Ellen take out of\nthe box?\n\n____ toys",
    "correctAnswer": "4",
    "choices": "",
    "fact": "12 - 8 = 4 (Ellen took out 4 toys out of the box)\n",
    "triviaType": "secondGradeMath",
    "level": "2"],
    ["question": "There are 9 birds in a tree.\nThen 6 more birds go in the\ntree. How many birds are in the tree altogether?\n\n____ birds",
    "correctAnswer": "15",
    "choices": "",
    "fact": "9 + 6 = 15 birds altogether\n",
    "triviaType": "secondGradeMath",
    "level": "2"],
    ["question": "Amy has 12 leaves. Max has\n4 leaves. Write a number\nsentence to show how many\nfewer leaves Max has than\nAmy.\n\n____  ⃝ ____  ⃝ ____\n____ leaves.\n",
    "correctAnswer": "8",
    "choices": "",
    "fact": "12 - 4 = 8 (Max has 8 leaves fewer than Amy)\n",
    "triviaType": "secondGradeMath",
    "level": "3"],
    ["question": "What is the sum?\n6 + 3 + 7 = ____\n",
       "correctAnswer": "16",
       ...
       "triviaType": "secondGradeMath",
       "level": "1"],
    ["question": "Write a related subtraction fact\nfor 5 + 7 = 12.\n\n____ - ____ = ____\n",
    "correctAnswer": "b",
    "choices": "a. 7 + 5 = 12\nb. 12 - 5 = 7\nc. 20 - 8 = 12\nd. 12 - 6 = 6\n",
    "fact": "12 - 5 = 7\n",
    "triviaType": "secondGradeMath",
    "level": "1"],
    ["question": "Lisa has 9 yellow flowers and\n5 red flowers in her garden.\nHow many flowers does Lisa\nhave in all?\n\n____ flowers\n",
      "correctAnswer": "14",
      "choices": "",
      "fact": "9 + 5 = 14 (Lisa has 14 flowers in all)\n",
      "triviaType": "secondGradeMath",
      "level": "2"],
    ["question": "Lucy had 13 pens. She gave\n5 of them to Hank. How many\npens does Lucy have now?\n\n____ pens.\n",
      "correctAnswer": "8",
      "choices": "",
      "fact": "13 - 5 = 8 (Lucy has 8 pens now)\n",
      "triviaType": "secondGradeMath",
      "level": "2"],
    ["question": "Sara picks up 8 blocks and 7 dolls. Then she picks\nup 2 balls. How many toys does Sara pick up?\n\n____ toys.\nUse numbers, pictures, or words to show one way\nto solve.\n",
         "correctAnswer": "17",
         "choices": "",
         "fact": "8 + 7 + 2 = 17 (Sara picks up 17 toys)\n",
         "triviaType": "secondGradeMath",
         "level": "3"],
    
    ["question": "Sara picks up 8 blocks and 7 dolls. Then she picks\nup 2 balls. How many more blocks than balls does Sara\npick up?\n\n____ more blocks.\nUse numbers, pictures, or words to show how you\nfound your answer.\n",
            "correctAnswer": "6",
            "choices": "",
            "fact": "8 - 2 = 6 (Sara picked up 6 more blocks than balls)\n",
            "triviaType": "secondGradeMath",
            "level": "3"],
  ]
}
